...
if __name__ == '__main__':
    ...
    if dataset_name == 'GTOT':
        ...
        seq_home = '/home/cx/cx2/mmtdata/RGB-T234'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()
    elif dataset_name == 'LasHeR':
        seq_home = '/home/cx/cx2/mmtdata/LasHeR/testingset'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()
        ...
        with open(join(seq_home, 'VTUAV-LT.txt'), 'r') as f:
            seq_list = f.read().splitlines()
    elif dataset_name == 'MUSTHSI':
        seq_home = '/home/tanxingyu/UNTrack-MUST/data/MUSTHSI'
        with open(join(seq_home, 'VTUAV-LT.txt'), 'r') as f:
            seq_list = f.read().splitlines()
    else:
