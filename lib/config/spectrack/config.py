...
cfg.MODEL.ENCODER.MOCE_RANK_SCALING = "constant"  # constant, nested, exponential
...
cfg.MODEL.ENCODER.MOCE_EXPERT_TYPE = "heterogeneous"  # heterogeneous, homogeneous
cfg.MODEL.ENCODER.MOCE_DEPTH_TYPE = "constant"  # constant, lin
cfg.MODEL.ENCODER.MOCE_USE_FREQ = True  # router uses frequency-aware prompt
cfg.MODEL.ENCODER.MOCE_USE_SHARED = True  # use shared global expert
cfg.MODEL.ENCODER.MOCE_FREQ_MODE = "spatial_spectral"  # legacy, spatial, spectral, spatial_spectral, spatial_spectral_joint
cfg.MODEL.ENCODER.MOCE_SHARED_TYPE = "attention"  # paper default: attention; optional: spectral_global
cfg.MODEL.ENCODER.MOCE_USE_COMPLEXITY_BIAS = True  # complexity-aware routing loss
cfg.MODEL.ENCODER.MOCE_COMPLEXITY_SCALE = "max"  # max, min
cfg.MODEL.ENCODER.MOCE_SPECTRAL_PERMUTE_SEED = -1  # -2 reverses latent channels; >=0 randomly permutes latent channels for diagnostics
cfg.MODEL.ENCODER.MOCE_SPECTRAL_SOURCE = "latent"  # latent, raw_band
cfg.MODEL.ENCODER.MOCE_ROUTING_NOISE_EVAL = True  # keep legacy behavior unless disabled for deterministic diagnostics
...
cfg.TRAIN.NON_BLOCKING_TRANSFER = True
cfg.TRAIN.MUST_MMAP_CACHE_SIZE = 128
...
cfg.TRAIN.SAVE_LAST_N = 10  # save checkpoints from the last N epochs
cfg.TRAIN.SAVE_EVERY_EPOCH = False
cfg.TRAIN.SAVE_EVERY_N = 10  # optional periodic checkpoint saving; set 0 to disable
