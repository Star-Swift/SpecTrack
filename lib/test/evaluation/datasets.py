...
dataset_dict = dict(
    ...
    musthsi=DatasetInfo(module=pt % "musthsi", class_name="MUSTHSIDataset", kwargs=dict()),
    msitrack=DatasetInfo(module=pt % "msitrack", class_name="MSITrackDataset", kwargs=dict()),
    hot2022=DatasetInfo(module=pt % "hot2022", class_name="HOT2022Dataset", kwargs=dict())
)
